...
O que este trabalho entrega que antes não existia (ou existia de forma muito mais cara): um conjunto hardware--software integrado (espectrômetro impresso em 3D + interface OSA Visível) que realiza análise espectral quantitativa na faixa 380--750 nm com calibração automatizada, acessível por menos de 200 dólares (USD) --- em contraste com os mais de 30 mil dólares (USD) dos OSAs comerciais. A inovação reside na migração da garantia de precisão da engenharia óptica de alto custo para algoritmos de visão computacional, mantendo resultados satisfatórios para a faixa visível.

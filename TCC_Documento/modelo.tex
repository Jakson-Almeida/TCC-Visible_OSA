...
Os experimentos foram realizados utilizando o espectrômetro OSA Visível desenvolvido conforme descrito no Capítulo 3, e um OSA comercial da ThorLabs (modelo OSA20xC) como referência para validação cruzada. % TODO: Adicionar figura do setup experimental (Figura \ref{fig:setup_experimental}) quando a imagem estiver disponível.

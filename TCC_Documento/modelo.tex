...
\begin{figure}[ht]
\centering
% TODO: Inserir imagem em figuras/setup_experimento_caracterizacao.png (fonte de luz, espectrômetro OSA Visível, espectrômetro ThorLabs)
\fbox{\parbox{0.85\textwidth}{\centering\vspace{4cm}[Imagem a ser inserida: Setup do experimento com fonte de luz, espectrômetro OSA Visível e espectrômetro ThorLabs]\vspace{4cm}}}
\caption{Setup do experimento de caracterização: (1) Fonte de luz com LEDs verde, vermelho e azul e controle PWM; (2) Espectrômetro OSA Visível; (3) Espectrômetro compacto ThorLabs (modelo CCT11, 350--700 nm, resolução $<$ 0,5 nm).}
\label{fig:setup_caracterizacao}
\fonte{A ser elaborada pelo autor.}
\end{figure}
...
A determinação do comprimento de onda e da intensidade de cada pico foi realizada com o auxílio do software \textit{Peaks Viewer} (\texttt{peaks\_viewer.py}), desenvolvido em Python. O usuário seleciona manualmente a região de interesse no espectro; em seguida, é ajustada uma curva Lorentziana (ou Gaussiana) nessa faixa, e o pico é identificado pelo melhor ajuste. Os valores de $\lambda$ e intensidade são obtidos a partir desse ajuste e registrados.

\begin{figure}[ht]
\centering
% TODO: Inserir imagem em figuras/peaks_viewer_interface.png (screenshot do Peaks Viewer)
\fbox{\parbox{0.85\textwidth}{\centering\vspace{3cm}[Imagem a ser inserida: Interface do Peaks Viewer]\vspace{3cm}}}
\caption{Interface do \textit{Peaks Viewer}: visualização do espectro, seleção de região para ajuste de curva Lorentziana/Gaussiana e extração de $\lambda$ e intensidade do pico.}
...
\begin{figure}[ht]
\centering
% TODO: Inserir imagem em figuras/app_cadastro_dados_interface.png (screenshot da aplicação web de cadastro)
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Imagem a ser inserida: Interface da aplicação web de cadastro de dados]\vspace{3cm}}}

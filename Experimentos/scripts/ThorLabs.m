% ThorLabs.m
% Script para análise dos dados do ThorLabs OSA
...
csv_file = 'dados_thorlabs_2026-01-29T20-44-22.213Z.csv';
...
% Ajustar layout
sgtitle('ThorLabs OSA - Análise de Intensidade por Duty Cycle', ...
        'FontSize', 14, 'FontWeight', 'bold');

% Salvar figura
output_file = 'ThorLabs_intensidade_vs_dutycycle.png';
